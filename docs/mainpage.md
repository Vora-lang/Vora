...
The v1.0 candidate grammar (EBNF) is frozen in [`docs/16-v1.0-grammar-ebnf.md`](16-v1.0-grammar-ebnf.md)
and tracks the parser after Phase 1 P0–P1 (ASI, ternary precedence, named arguments,
import basename validation). Changes to `src/parser/` must be reflected there.
